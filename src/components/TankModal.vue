              ...
              <tr>
                ...
                <td class="text-right">
                  <img
                    ...
                    class="badge-image"
                    :src="getMasteryBadge(tank.mark_of_mastery)"
                    alt="Mastery badge"
                  />
                </td>
              </tr>
...
export default defineComponent({
  ...
  methods: {
    ...
    getMasteryBadge(badge: number) {
      ...
      else if (badge === 3) return require("../assets/mastery-class-1.png");
      else if (badge === 2) return require("../assets/mastery-class-2.png");
      else if (badge === 1) return require("../assets/mastery-class-3.png");
    },
  },
});
</script>
