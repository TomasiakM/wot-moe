<template>
    <div class="mb-3">
        ...
        >
            <h6 class="mb-0">
                Moe
                <span v-if="moeFilter.length">({{ moeFilter.length }})</span>
            </h6>
            <i class="bi bi-caret-down-fill"></i>
        </header>

        <div
            class="filter-content collapse border-bottom"
            id="collapse_filter1"
        >
        ...
        >
            <h6 class="mb-0">
                Tier
                <span v-if="tierFilter.length">({{ tierFilter.length }})</span>
            </h6>
            <i class="bi bi-caret-down-fill"></i>
        </header>
        ...
        >
            <h6 class="mb-0">
                Type
                <span v-if="typeFilter.length">({{ typeFilter.length }})</span>
            </h6>
            <i class="bi bi-caret-down-fill"></i>
        </header>
        ...
        >
            <h6 class="mb-0">
                Nation
                <span v-if="nationFilter.length"
                    >({{ nationFilter.length }})</span
                >
            </h6>
            <i class="bi bi-caret-down-fill"></i>
        </header>
...
export default defineComponent({
    ...
    props: {
        tanks: Array as PropType<IPlayerTank[]>,
    },
    watch: {
        moeFilter() {
            this.emitData();
    ...
    computed: {
        ...
        getAmountOfTanks() {
            ...
            tanks?.forEach((tank: IPlayerTank) => {
                const { marksOnGun } = tank;
                const { nation, tier, type } = this.tanksList[tank.tank_id];
